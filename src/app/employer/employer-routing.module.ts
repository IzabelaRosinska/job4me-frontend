...
const routes: Routes = [
  ...
  {path: 'employer/employees/list-display', component: SavedListComponent, data: {routeMainPart: 'employees/list-display', routeToElement: '/employer/employee/', routeToDelete: 'delete-employee'}},
