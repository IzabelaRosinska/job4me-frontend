...
const routes: Routes = [
  ...
  {path: 'employee/saved-employers', component: SavedListComponent, data: {routeMainPart: 'get-saved-employers', routeToElement: '/employer/save-employer/'}},
  {path: 'employee/saved-job-offers', component: SavedListComponent, data: {routeMainPart: 'get-saved-offers', routeToElement: '/employer/save-offer/'}},
